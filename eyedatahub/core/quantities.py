...
QUANTITY_EVIDENCE: tuple[QuantityEvidence, ...] = (
    ...
    _q("dryad_cornea_oct_pentacam", 1, "deposited_files", "OCT_.zip in the current Dryad version", "https://doi.org/10.5061/dryad.tht76hf0c", basis="current_deposit_file_listing", notes="The archive does not expose a reproducible participant, eye, volume, or B-scan count without inspecting the credentialed contents."),
    _q("dryad_functional_oct_alzheimer", 1, "deposited_files", "RAR archive in the current Dryad version", "https://doi.org/10.5061/dryad.msbcc2ftc", basis="current_deposit_file_listing", notes="The source describes four experiments but does not expose a single non-overlapping participant or image total."),
    ...
    _q("fang_sbsdi_oct", 41, "participants", "Human participants described by the associated paper", "https://doi.org/10.1109/TMI.2013.2271904", basis="associated_publication", primary=True, notes="The archive also contains software and mouse imaging data; a file-level image count is not asserted."),
