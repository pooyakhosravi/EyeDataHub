...
| `llms-full.txt` | Token-efficient full catalog of all 479 records. |
...
| `from eyedatahub.datasets.registry import REGISTRY` | Direct Python access to 479 auto-registered records; `REGISTRY` is an internal compatibility name. |
