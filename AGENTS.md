...
| `llms-full.txt` | Token-efficient full catalog of all 475 current records. |
...
| `from eyedatahub.datasets.registry import REGISTRY` | Direct Python access to 475 auto-registered current records; `REGISTRY` is an internal compatibility name. |
