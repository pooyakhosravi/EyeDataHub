---
id: dryad_q6w37t8b
title: "10x Lacrimal Gland scRNA seq data matrix"
sidebar_label: dryad_q6w37t8b
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_q6w37t8b` |
| **Full name** | 10x Lacrimal Gland scRNA seq data matrix |
...
> Scope screen: adjacent_add. Current Dryad v1 file listing: 6 files, 15630284 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_q6w37t8b --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_q6w37t8b --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_q6w37t8b')
...
**Upstream page:** [https://doi.org/10.7272/q6w37t8b](https://doi.org/10.7272/q6w37t8b)

**Source-term evidence:** [https://doi.org/10.7272/q6w37t8b](https://doi.org/10.7272/q6w37t8b)
...
@misc{dryad_q6w37t8b,
  title  = { 10x Lacrimal Gland scRNA seq data matrix },
  note   = { Yu Shengyang, Tward Aaron, Knox Sarah. 10x Lacrimal Gland scRNA seq data matrix. Dryad. 2017. doi:10.7272/q6w37t8b },
  year   = { 2017 },
  url    = { https://doi.org/10.7272/q6w37t8b },
}
```
...
```text
Yu Shengyang, Tward Aaron, Knox Sarah. 10x Lacrimal Gland scRNA seq data matrix. Dryad. 2017. doi:10.7272/q6w37t8b
```
