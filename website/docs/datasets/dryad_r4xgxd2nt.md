---
id: dryad_r4xgxd2nt
title: "Restoration of cone circuit functionality in the regenerating adult zebrafish retina"
sidebar_label: dryad_r4xgxd2nt
description: "Official Dryad deposit of source-described retinal physiology data for the associated study."
tags: ["electrophysiology", "cell_microscopy", "cc0", "dryad", "measurement", "restoration"]
---
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_r4xgxd2nt` |
| **Full name** | Restoration of cone circuit functionality in the regenerating adult zebrafish retina |
| **Primary category** | `electrophysiology` |
| **Contained modalities** | electrophysiology, cell_microscopy |
...
> Scope screen: adjacent_add. Current Dryad v6 file listing: 6 files, 3340308791 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_r4xgxd2nt --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_r4xgxd2nt --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_r4xgxd2nt')
...
**Upstream page:** [https://doi.org/10.5061/dryad.r4xgxd2nt](https://doi.org/10.5061/dryad.r4xgxd2nt)

**Source-term evidence:** [https://doi.org/10.5061/dryad.r4xgxd2nt](https://doi.org/10.5061/dryad.r4xgxd2nt)
...
```bibtex
@misc{dryad_r4xgxd2nt,
  title  = { Restoration of cone circuit functionality in the regenerating adult zebrafish retina },
  note   = { Abraham Evelyn, Hartmann Hella, Yoshimatsu Takeshi, Baden Tom, Brand Michael. Restoration of cone circuit functionality in the regenerating adult zebrafish retina. Dryad. 2024. doi:10.5061/dryad.r4xgxd2nt },
  year   = { 2024 },
  url    = { https://doi.org/10.5061/dryad.r4xgxd2nt },
}
```
...
```text
Abraham Evelyn, Hartmann Hella, Yoshimatsu Takeshi, Baden Tom, Brand Michael. Restoration of cone circuit functionality in the regenerating adult zebrafish retina. Dryad. 2024. doi:10.5061/dryad.r4xgxd2nt
```
