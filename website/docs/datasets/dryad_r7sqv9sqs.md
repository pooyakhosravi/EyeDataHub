---
id: dryad_r7sqv9sqs
title: "Deletion in CACNA1F gene causes X-linked progressive retinal atrophy in English Cocker Spaniel dogs"
sidebar_label: dryad_r7sqv9sqs
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_r7sqv9sqs` |
| **Full name** | Deletion in CACNA1F gene causes X-linked progressive retinal atrophy in English Cocker Spaniel dogs |
...
> Scope screen: adjacent_add. Current Dryad v4 file listing: 11 files, 139241181282 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_r7sqv9sqs --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_r7sqv9sqs --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_r7sqv9sqs')
...
**Upstream page:** [https://doi.org/10.5061/dryad.r7sqv9sqs](https://doi.org/10.5061/dryad.r7sqv9sqs)

**Source-term evidence:** [https://doi.org/10.5061/dryad.r7sqv9sqs](https://doi.org/10.5061/dryad.r7sqv9sqs)
...
```bibtex
@misc{dryad_r7sqv9sqs,
  title  = { Deletion in CACNA1F gene causes X-linked progressive retinal atrophy in English Cocker Spaniel dogs },
  note   = { Bionda Arianna, Liotta Luigi, Floridia Viviana, Niggel Jessica, Giretto Daniela, Aguirre Gustavo, Crepaldi Paola, Murgiano Leonardo. Deletion in CACNA1F gene causes X-linked progressive retinal atrophy in English Cocker Spaniel dogs. Dryad. 2026. doi:10.5061/dryad.r7sqv9sqs },
  year   = { 2026 },
  url    = { https://doi.org/10.5061/dryad.r7sqv9sqs },
}
```
...
```text
Bionda Arianna, Liotta Luigi, Floridia Viviana, Niggel Jessica, Giretto Daniela, Aguirre Gustavo, Crepaldi Paola, Murgiano Leonardo. Deletion in CACNA1F gene causes X-linked progressive retinal atrophy in English Cocker Spaniel dogs. Dryad. 2026. doi:10.5061/dryad.r7sqv9sqs
```
