...
# Parkinson Disease Directional OCT Dataset

Processed outer-retinal thickness and reflectance measurements from a Parkinson disease directional-OCT study.
...
> Distinct deposit. Possible study or cohort overlap with Figshare 24138420 remains unresolved, so no catalog relationship is asserted.
...
```bash
# Read-only preflight
eyehub download parkinsons_directional_oct --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download parkinsons_directional_oct --data-dir ./data
```
...
ds = REGISTRY.get_dataset('parkinsons_directional_oct')
...
**Upstream page:** [https://doi.org/10.26188/30750011.v1](https://doi.org/10.26188/30750011.v1)

**Source-term evidence:** [https://doi.org/10.26188/30750011.v1](https://doi.org/10.26188/30750011.v1)
...
```bibtex
@misc{parkinsons_directional_oct,
  title  = { Parkinson Disease Directional OCT Dataset },
  note   = { Repository dataset record. 10.26188/30750011.v1 },
  url    = { https://doi.org/10.26188/30750011.v1 },
}
```
...
```text
Repository dataset record. 10.26188/30750011.v1.
```
