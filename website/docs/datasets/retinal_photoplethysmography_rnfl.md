---
id: retinal_photoplethysmography_rnfl
...
# Retinal Photoplethysmography and RNFL Dataset

Human retinal photoplethysmography and retinal-nerve-fiber-layer measurements.
...
| **Publication date evidence** | [api.figshare.com/v2](https://api.figshare.com/v2/articles/21197173/versions/1) |
...
```bash
# Read-only preflight
eyehub download retinal_photoplethysmography_rnfl --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download retinal_photoplethysmography_rnfl --data-dir ./data
```
...
ds = REGISTRY.get_dataset('retinal_photoplethysmography_rnfl')
...
**Upstream page:** [https://doi.org/10.6084/m9.figshare.21197173.v1](https://doi.org/10.6084/m9.figshare.21197173.v1)

**Source-term evidence:** [https://doi.org/10.6084/m9.figshare.21197173.v1](https://doi.org/10.6084/m9.figshare.21197173.v1)
...
```bibtex
@misc{retinal_photoplethysmography_rnfl,
  title  = { Retinal Photoplethysmography and RNFL Dataset },
  note   = { Repository dataset record. 10.6084/m9.figshare.21197173.v1 },
  url    = { https://doi.org/10.6084/m9.figshare.21197173.v1 },
}
```
...
```text
Repository dataset record. 10.6084/m9.figshare.21197173.v1.
```
