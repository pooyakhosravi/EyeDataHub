---
id: mendeley_proteomic_analysis_human_autoimmune_retinopathy_air
...
| --- | ---: | --- | --- | --- | --- |
| Primary | 5 | `participants` | Source-stated quantity Preserved from the source-confirmation record. | `official_source_description` | [data.mendeley.com/datasets](https://data.mendeley.com/datasets/t7yrm5x3ws) |

Counts retain their source-reported units. Additional rows can describe components, paired items, or derivative copies and are not automatically added to the primary quantity.

## Notes

> Human provenance: Vitreous from two AIR patients and three macular-hole controls. Source-review finding: Indexed metadata describes LC-MS/MS proteomic data.
...
```bash
# Read-only preflight
eyehub download mendeley_proteomic_analysis_human_autoimmune_retinopathy_air --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download mendeley_proteomic_analysis_human_autoimmune_retinopathy_air --data-dir ./data
```
...
ds = REGISTRY.get_dataset('mendeley_proteomic_analysis_human_autoimmune_retinopathy_air')
...
**Upstream page:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/t7yrm5x3ws/1)

**Source-term evidence:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/t7yrm5x3ws)
...
```bibtex
@misc{mendeley_proteomic_analysis_human_autoimmune_retinopathy_air,
  title  = { Proteomic analysis of human autoimmune retinopathy (AIR) vitreous },
  note   = { Proteomic analysis of human autoimmune retinopathy (AIR) vitreous. Mendeley Data, V1. doi:10.17632/t7yrm5x3ws.1 },
  url    = { https://data.mendeley.com/datasets/t7yrm5x3ws/1 },
}
```
...
```text
Proteomic analysis of human autoimmune retinopathy (AIR) vitreous. Mendeley Data, V1. doi:10.17632/t7yrm5x3ws.1.
```
