---
id: dryad_macaque_cone_ratio
title: "Rhesus macaque cone ratio heritability"
sidebar_label: dryad_macaque_cone_ratio
description: "Named cone-expression and pedigree tables provide a defined primate retinal biometrics/genetics resource with plausible translational relevance."
tags: ["omics", "tabular", "cc0", "dryad", "measurement"]
---
...
Named cone-expression and pedigree tables provide a defined primate retinal biometrics/genetics resource with plausible translational relevance.

## At a glance

| Field | Value |
| --- | --- |
| **Short name** | `dryad_macaque_cone_ratio` |
| **Full name** | Rhesus macaque cone ratio heritability |
...
> Scope: adjacent_add. Named file-level object: ddPCR and pedigree CSVs plus README. Official Dryad API metadata and current file listing reviewed 2026-08-01.
...
```bash
# Read-only preflight
eyehub download dryad_macaque_cone_ratio --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_macaque_cone_ratio --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_macaque_cone_ratio')
...
**Upstream page:** [https://doi.org/10.5061/dryad.gf1vhhmsc](https://doi.org/10.5061/dryad.gf1vhhmsc)

**Source-term evidence:** [https://doi.org/10.5061/dryad.gf1vhhmsc](https://doi.org/10.5061/dryad.gf1vhhmsc)
...
```bibtex
@misc{dryad_macaque_cone_ratio,
  title  = { Rhesus macaque cone ratio heritability },
  note   = { Rhesus macaque cone ratio heritability. Dryad Dataset. doi:10.5061/dryad.gf1vhhmsc },
  url    = { https://doi.org/10.5061/dryad.gf1vhhmsc },
}
```
...
```text
Rhesus macaque cone ratio heritability. Dryad Dataset. doi:10.5061/dryad.gf1vhhmsc.
```
