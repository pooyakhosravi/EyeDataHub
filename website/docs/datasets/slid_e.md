...
# SLID-E Slit-Lamp Image Dataset for Epiphora
...
| --- | ---: | --- | --- | --- | --- |
| Primary | 2,999 | `images` | Source reports 2,999 slit-lamp photographs from 1,563 patients. Source-stated quantity; repository file count is separate. | `official_source_description` | [https://doi.org/10.6084/m9.figshare.26172919.v2](https://doi.org/10.6084/m9.figshare.26172919.v2) |

Counts retain their source-reported units. Additional rows can describe components, paired items, or derivative copies and are not automatically added to the primary quantity.

## Notes

> Distinct from the cataloged SLID resource.
...
```bash
# Read-only preflight
eyehub download slid_e --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download slid_e --data-dir ./data
```
...
ds = REGISTRY.get_dataset('slid_e')
...
**Upstream page:** [https://doi.org/10.6084/m9.figshare.26172919.v2](https://doi.org/10.6084/m9.figshare.26172919.v2)

**Source-term evidence:** [https://doi.org/10.6084/m9.figshare.26172919.v2](https://doi.org/10.6084/m9.figshare.26172919.v2)
...
@misc{slid_e,
  title  = { SLID-E Slit-Lamp Image Dataset for Epiphora },
  note   = { Repository dataset record. 10.6084/m9.figshare.26172919.v2 },
  url    = { https://doi.org/10.6084/m9.figshare.26172919.v2 },
}
```
...
```text
Repository dataset record. 10.6084/m9.figshare.26172919.v2.
```
...
- [slp_vld](./slp_vld.md): SLP-VLD Anonymized Slit-Lamp Vision-Language Dataset (2,228 images, `cc-by`)
