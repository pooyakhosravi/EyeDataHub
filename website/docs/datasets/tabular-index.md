...
description: "27 resources containing tabular data in EyeDataHub."
---
...
| [`uveitis_smote`](./uveitis_smote.md) | Image Dataset on Eye Diseases Classification with Symptoms and SMOTE Validation | 3,245 | 0.5 GB | `cc-by` | Mendeley Data |
| [`eed_astig`](./eed_astig.md) | EED-Astig Pediatric External-Eye Dataset | 3,088 | 0.4 GB | `research-only` | Manual (upstream-gated) |
| [`dryad_namd_oct_quant`](./dryad_namd_oct_quant.md) | Moorfields nAMD Quantitative OCT Biomarker Dataset | 2,966 | 0.0 GB | `cc0` | Dryad |
| [`ghana_eye_screening`](./ghana_eye_screening.md) | Eye Screening Data for First-Year University Students in Ghana | 2,494 | 0.0 GB | `cc-by-nc-nd` | Mendeley Data |
| [`perg_ioba`](./perg_ioba.md) | PERG-IOBA Ocular Electrophysiology Dataset | 1,354 | 0.1 GB | `odc-by` | PhysioNet |
...
| [`chronic_corneal_disorders`](./chronic_corneal_disorders.md) | Chronic Corneal Disorders Clinical Dataset | 332 | 0.0 GB | `cc-by` | Mendeley Data |
