...
| **Date notes** | Official Dryad API v2 publicationDate; current record version 9. |
...
> Scope screen: adjacent_add. Current Dryad v9 file listing: 4 files, 44225447 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_d1zd5s --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_d1zd5s --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_d1zd5s')
...
**Upstream page:** [https://doi.org/10.5068/d1zd5s](https://doi.org/10.5068/d1zd5s)

**Source-term evidence:** [https://doi.org/10.5068/d1zd5s](https://doi.org/10.5068/d1zd5s)
...
@misc{dryad_d1zd5s,
  title  = { Single cell transcriptomic analyses reveal the impact of bHLH factors on human retinal organoid development },
  note   = { Yang Xian-Jie, Zhang Xiangmei, Mandric Igor, Nguyen Kevin, Nguyen Thao, Pellegrini Matteo, Grove James, Barnes Steven. Single cell transcriptomic analyses reveal the impact of bHLH factors on human retinal organoid development. Dryad. 2021. doi:10.5068/d1zd5s },
  year   = { 2021 },
  url    = { https://doi.org/10.5068/d1zd5s },
}
```
...
```text
Yang Xian-Jie, Zhang Xiangmei, Mandric Igor, Nguyen Kevin, Nguyen Thao, Pellegrini Matteo, Grove James, Barnes Steven. Single cell transcriptomic analyses reveal the impact of bHLH factors on human retinal organoid development. Dryad. 2021. doi:10.5068/d1zd5s
```
