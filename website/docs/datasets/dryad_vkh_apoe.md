...
# VKH APOE Transcriptomics and Proteomics Dataset
...
| **Publication date evidence** | [https://doi.org/10.5061/dryad.37pvmcvzx](https://doi.org/10.5061/dryad.37pvmcvzx) |
...
> Scope screen: core_add. Current Dryad v3 file listing: 5 files, 68879258875 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_vkh_apoe --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_vkh_apoe --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_vkh_apoe')
...
**Upstream page:** [https://doi.org/10.5061/dryad.37pvmcvzx](https://doi.org/10.5061/dryad.37pvmcvzx)

**Source-term evidence:** [https://doi.org/10.5061/dryad.37pvmcvzx](https://doi.org/10.5061/dryad.37pvmcvzx)
...
@misc{dryad_vkh_apoe,
  title  = { VKH APOE Transcriptomics and Proteomics Dataset },
  note   = { Hou, Shengping, and Lei, Fengyang. Data from: Bulk-seq results from peripheral blood mononuclear cells (PBMCs) of VKH patients and proteomic profiling of shAPOE-transduced HMC3 cells were employed to uncover potential downstream targets of APOE. Dryad. 2025. doi:10.5061/dryad.37pvmcvzx },
  year   = { 2025 },
  url    = { https://doi.org/10.5061/dryad.37pvmcvzx },
}
```
...
```text
Hou, Shengping, and Lei, Fengyang. Data from: Bulk-seq results from peripheral blood mononuclear cells (PBMCs) of VKH patients and proteomic profiling of shAPOE-transduced HMC3 cells were employed to uncover potential downstream targets of APOE. Dryad. 2025. doi:10.5061/dryad.37pvmcvzx
```
