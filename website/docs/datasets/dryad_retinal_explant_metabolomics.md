---
id: dryad_retinal_explant_metabolomics
title: "NMR spectroscopy-based metabolomics of organotypic retinal explants"
sidebar_label: dryad_retinal_explant_metabolomics
description: "The dedicated raw retinal-explant metabolomics archive is a defined translational retinal-metabolism resource."
...
The dedicated raw retinal-explant metabolomics archive is a defined translational retinal-metabolism resource.

## At a glance

| Field | Value |
| --- | --- |
| **Short name** | `dryad_retinal_explant_metabolomics` |
| **Full name** | NMR spectroscopy-based metabolomics of organotypic retinal explants |
...
> Scope: adjacent_add. Named file-level object: Retina_Metabolomics_raw_data_update.zip plus README. Official Dryad API metadata and current file listing reviewed 2026-08-01.
...
```bash
# Read-only preflight
eyehub download dryad_retinal_explant_metabolomics --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_retinal_explant_metabolomics --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_retinal_explant_metabolomics')
...
**Upstream page:** [https://doi.org/10.5061/dryad.c2fqz61hr](https://doi.org/10.5061/dryad.c2fqz61hr)

**Source-term evidence:** [https://doi.org/10.5061/dryad.c2fqz61hr](https://doi.org/10.5061/dryad.c2fqz61hr)
...
```bibtex
@misc{dryad_retinal_explant_metabolomics,
  title  = { NMR spectroscopy-based metabolomics of organotypic retinal explants },
  note   = { NMR spectroscopy-based metabolomics of organotypic retinal explants. Dryad Dataset. doi:10.5061/dryad.c2fqz61hr },
  url    = { https://doi.org/10.5061/dryad.c2fqz61hr },
}
```
...
```text
NMR spectroscopy-based metabolomics of organotypic retinal explants. Dryad Dataset. doi:10.5061/dryad.c2fqz61hr.
```
