---
id: casia2_as_oct_repeatability
...
# CASIA2 Anterior-Segment OCT Repeatability Dataset

Human CASIA2 anterior-segment OCT repeatability measurements.
...
| **Publication date evidence** | [api.figshare.com/v2](https://api.figshare.com/v2/articles/29302664/versions/1) |
...
```bash
# Read-only preflight
eyehub download casia2_as_oct_repeatability --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download casia2_as_oct_repeatability --data-dir ./data
```
...
ds = REGISTRY.get_dataset('casia2_as_oct_repeatability')
...
**Upstream page:** [https://doi.org/10.6084/m9.figshare.29302664.v1](https://doi.org/10.6084/m9.figshare.29302664.v1)

**Source-term evidence:** [https://doi.org/10.6084/m9.figshare.29302664.v1](https://doi.org/10.6084/m9.figshare.29302664.v1)
...
```bibtex
@misc{casia2_as_oct_repeatability,
  title  = { CASIA2 Anterior-Segment OCT Repeatability Dataset },
  note   = { Repository dataset record. 10.6084/m9.figshare.29302664.v1 },
  url    = { https://doi.org/10.6084/m9.figshare.29302664.v1 },
}
```
...
```text
Repository dataset record. 10.6084/m9.figshare.29302664.v1.
```
