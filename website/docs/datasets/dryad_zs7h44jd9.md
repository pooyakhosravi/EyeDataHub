---
id: dryad_zs7h44jd9
title: "Data for: Impact of alpha crystallin loss on zebrafish lens development"
sidebar_label: dryad_zs7h44jd9
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_zs7h44jd9` |
| **Full name** | Data for: Impact of alpha crystallin loss on zebrafish lens development |
...
> Scope screen: adjacent_add. Current Dryad v4 file listing: 2 files, 1795736344 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_zs7h44jd9 --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_zs7h44jd9 --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_zs7h44jd9')
...
**Upstream page:** [https://doi.org/10.5061/dryad.zs7h44jd9](https://doi.org/10.5061/dryad.zs7h44jd9)

**Source-term evidence:** [https://doi.org/10.5061/dryad.zs7h44jd9](https://doi.org/10.5061/dryad.zs7h44jd9)
...
```bibtex
@misc{dryad_zs7h44jd9,
  title  = { Data for: Impact of alpha crystallin loss on zebrafish lens development },
  note   = { Posner Mason. Data for: Impact of alpha crystallin loss on zebrafish lens development. Dryad. 2022. doi:10.5061/dryad.zs7h44jd9 },
  year   = { 2022 },
  url    = { https://doi.org/10.5061/dryad.zs7h44jd9 },
}
```
...
```text
Posner Mason. Data for: Impact of alpha crystallin loss on zebrafish lens development. Dryad. 2022. doi:10.5061/dryad.zs7h44jd9
```
