---
id: mendeley_test_results_article_motion_perception_glaucoma
...
# Test results - Article "Motion perception and glaucoma"

Observation-level human or human-derived measurements/signals. from Glaucoma and healthy human participants.
...
| **Publication date evidence** | [data.mendeley.com/datasets](https://data.mendeley.com/datasets/zhz8kjsykf/1) |
...
> Human provenance: Glaucoma and healthy human participants. Source-review finding: Test-execution table with endpoint motion-perception localization-error values.
...
```bash
# Read-only preflight
eyehub download mendeley_test_results_article_motion_perception_glaucoma --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download mendeley_test_results_article_motion_perception_glaucoma --data-dir ./data
```
...
ds = REGISTRY.get_dataset('mendeley_test_results_article_motion_perception_glaucoma')
...
**Upstream page:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/zhz8kjsykf/1)

**Source-term evidence:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/zhz8kjsykf)
...
```bibtex
@misc{mendeley_test_results_article_motion_perception_glaucoma,
  title  = { Test results - Article "Motion perception and glaucoma" },
  note   = { Test results - Article "Motion perception and glaucoma". Mendeley Data, V1. doi:10.17632/zhz8kjsykf.1 },
  url    = { https://data.mendeley.com/datasets/zhz8kjsykf/1 },
}
```
...
```text
Test results - Article "Motion perception and glaucoma". Mendeley Data, V1. doi:10.17632/zhz8kjsykf.1.
```
