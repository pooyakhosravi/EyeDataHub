...
tags: ["adaptive_optics", "eye_tracking", "tabular", "cc-by", "mendeley", "prediction", "resource-role-current-dataset", "dataset-family-mendeley-sub-cone-visual-resolution-by-active"]
---
...
| **Publication date evidence** | [data.mendeley.com/datasets](https://data.mendeley.com/datasets/zp6d5w8kdv/1) |
...
| **Contained modalities** | adaptive_optics, eye_tracking, tabular |
| **Tasks** | prediction |
...
- [mendeley_code_manuscript_fixational_eye_movements_as](./mendeley_code_manuscript_fixational_eye_movements_as.md): Data and code for manuscript: Fixational eye movements as active sensation for high visual acuity (Not reported, `cc-by`)
