---
id: dryad_glaucoma_lhon_mitochondrial
...
# Glaucoma and LHON Mitochondrial Function Dataset

Systemic mitochondrial-function measurements are directly linked to human glaucoma and LHON disease mechanisms.
...
| **Publication date evidence** | [https://doi.org/10.5061/dryad.2k4v4](https://doi.org/10.5061/dryad.2k4v4) |
...
> Scope screen: core_add. Current Dryad v1 file listing: 1 files, 14688 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_glaucoma_lhon_mitochondrial --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_glaucoma_lhon_mitochondrial --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_glaucoma_lhon_mitochondrial')
...
**Upstream page:** [https://doi.org/10.5061/dryad.2k4v4](https://doi.org/10.5061/dryad.2k4v4)

**Source-term evidence:** [https://doi.org/10.5061/dryad.2k4v4](https://doi.org/10.5061/dryad.2k4v4)
...
```bibtex
@misc{dryad_glaucoma_lhon_mitochondrial,
  title  = { Glaucoma and LHON Mitochondrial Function Dataset },
  note   = { Van Bergen, Nicole J., Crowston, Jonathan G., Craig, Jamie E., Burdon, Kathryn P., Kearns, Lisa S., Sharma, Shiwani, Hewitt, Alex W., Mackey, David A., and Trounce, Ian A.. Data from: Measurement of systemic mitochondrial function in advanced primary open-angle glaucoma and Leber hereditary optic neuropathy. Dryad. 2016. doi:10.5061/dryad.2k4v4 },
  year   = { 2016 },
  url    = { https://doi.org/10.5061/dryad.2k4v4 },
}
```
