---
id: dryad_z08kprrk3
title: "Data from: A naturally occurring canine model of syndromic congenital microphthalmia"
sidebar_label: dryad_z08kprrk3
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_z08kprrk3` |
| **Full name** | Data from: A naturally occurring canine model of syndromic congenital microphthalmia |
...
> Scope screen: adjacent_add. Current Dryad v8 file listing: 5 files, 26446559668 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_z08kprrk3 --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_z08kprrk3 --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_z08kprrk3')
...
**Upstream page:** [https://doi.org/10.5061/dryad.z08kprrk3](https://doi.org/10.5061/dryad.z08kprrk3)

**Source-term evidence:** [https://doi.org/10.5061/dryad.z08kprrk3](https://doi.org/10.5061/dryad.z08kprrk3)
...
```bibtex
@misc{dryad_z08kprrk3,
  title  = { Data from: A naturally occurring canine model of syndromic congenital microphthalmia },
  note   = { Murgiano Leonardo, Banjeree Esha, O'Connor Cynthia, Miyadera Keiko, Werner Petra, Aguirre Gustavo, Casal Margret. Data from: A naturally occurring canine model of syndromic congenital microphthalmia . Dryad. 2024. doi:10.5061/dryad.z08kprrk3 },
  year   = { 2024 },
  url    = { https://doi.org/10.5061/dryad.z08kprrk3 },
}
```
...
```text
Murgiano Leonardo, Banjeree Esha, O'Connor Cynthia, Miyadera Keiko, Werner Petra, Aguirre Gustavo, Casal Margret. Data from: A naturally occurring canine model of syndromic congenital microphthalmia . Dryad. 2024. doi:10.5061/dryad.z08kprrk3
```
