---
id: dryad_vq83bk3s8
title: "Spatially displaced excitation contributes to the encoding of interrupted motion by the retinal direction-selective circuit"
sidebar_label: dryad_vq83bk3s8
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_vq83bk3s8` |
| **Full name** | Spatially displaced excitation contributes to the encoding of interrupted motion by the retinal direction-selective circuit |
...
> Scope screen: adjacent_add. Current Dryad v5 file listing: 910 files, 6461489656 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_vq83bk3s8 --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_vq83bk3s8 --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_vq83bk3s8')
...
**Upstream page:** [https://doi.org/10.5061/dryad.vq83bk3s8](https://doi.org/10.5061/dryad.vq83bk3s8)

**Source-term evidence:** [https://doi.org/10.5061/dryad.vq83bk3s8](https://doi.org/10.5061/dryad.vq83bk3s8)
...
```bibtex
@misc{dryad_vq83bk3s8,
  title  = { Spatially displaced excitation contributes to the encoding of interrupted motion by the retinal direction-selective circuit },
  note   = { Ding Jennifer. Spatially displaced excitation contributes to the encoding of interrupted motion by the retinal direction-selective circuit. Dryad. 2021. doi:10.5061/dryad.vq83bk3s8 },
  year   = { 2021 },
  url    = { https://doi.org/10.5061/dryad.vq83bk3s8 },
}
```
...
```text
Ding Jennifer. Spatially displaced excitation contributes to the encoding of interrupted motion by the retinal direction-selective circuit. Dryad. 2021. doi:10.5061/dryad.vq83bk3s8
```
