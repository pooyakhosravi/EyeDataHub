---
id: mendeley_rop_retinopathy_prematurity_infants_serum_metabolomic
...
# ROP (retinopathy of prematurity) infants' serum metabolomic data

Observation-level source data, annotations, or signals. from Source identifies serum metabolomic data from infants with retinopathy of prematurity.
...
> Human provenance: Source identifies serum metabolomic data from infants with retinopathy of prematurity. Source-review finding: 12 files including raw/scaled XLSX workbooks and TIFF data/figures.
...
```bash
# Read-only preflight
eyehub download mendeley_rop_retinopathy_prematurity_infants_serum_metabolomic --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download mendeley_rop_retinopathy_prematurity_infants_serum_metabolomic --data-dir ./data
```
...
ds = REGISTRY.get_dataset('mendeley_rop_retinopathy_prematurity_infants_serum_metabolomic')
...
**Upstream page:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/7r7xt6pf6x/5)

**Source-term evidence:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/7r7xt6pf6x)
...
```bibtex
@misc{mendeley_rop_retinopathy_prematurity_infants_serum_metabolomic,
  title  = { ROP (retinopathy of prematurity) infants' serum metabolomic data },
  note   = { ROP (retinopathy of prematurity) infants' serum metabolomic data. Mendeley Data, V5. doi:10.17632/7r7xt6pf6x.5 },
  url    = { https://data.mendeley.com/datasets/7r7xt6pf6x/5 },
}
```
...
```text
ROP (retinopathy of prematurity) infants' serum metabolomic data. Mendeley Data, V5. doi:10.17632/7r7xt6pf6x.5.
```
