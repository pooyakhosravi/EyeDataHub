---
id: dryad_z08kprrk6
title: "Frameshift variant in AMPD2 in Cirneco dell’ Etna with retinopathy and tremors"
sidebar_label: dryad_z08kprrk6
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_z08kprrk6` |
| **Full name** | Frameshift variant in AMPD2 in Cirneco dell’ Etna with retinopathy and tremors |
...
> Scope screen: adjacent_add. Current Dryad v4 file listing: 7 files, 123431491592 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_z08kprrk6 --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_z08kprrk6 --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_z08kprrk6')
...
**Upstream page:** [https://doi.org/10.5061/dryad.z08kprrk6](https://doi.org/10.5061/dryad.z08kprrk6)

**Source-term evidence:** [https://doi.org/10.5061/dryad.z08kprrk6](https://doi.org/10.5061/dryad.z08kprrk6)
...
```bibtex
@misc{dryad_z08kprrk6,
  title  = { Frameshift variant in AMPD2 in Cirneco dell’ Etna with retinopathy and tremors },
  note   = { Murgiano Leonardo, Niggel Jessica K., Benedicenti Leontine, Bionda Arianna, Crepaldi Paola, Liotta Luigi, Beltran William, Aguirre Gustavo D.. Frameshift variant in AMPD2 in Cirneco dell Etna with retinopathy and tremors. Dryad. 2024. doi:10.5061/dryad.z08kprrk6 },
  year   = { 2024 },
  url    = { https://doi.org/10.5061/dryad.z08kprrk6 },
}
```
...
```text
Murgiano Leonardo, Niggel Jessica K., Benedicenti Leontine, Bionda Arianna, Crepaldi Paola, Liotta Luigi, Beltran William, Aguirre Gustavo D.. Frameshift variant in AMPD2 in Cirneco dell Etna with retinopathy and tremors. Dryad. 2024. doi:10.5061/dryad.z08kprrk6
```
