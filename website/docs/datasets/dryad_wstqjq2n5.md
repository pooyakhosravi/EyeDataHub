...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_wstqjq2n5` |
| **Full name** | Data from: Spectral inference reveals principal cone-integration rules of the zebrafish inner retina |
...
> Scope screen: adjacent_add. Current Dryad v4 file listing: 4 files, 310660490 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_wstqjq2n5 --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_wstqjq2n5 --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_wstqjq2n5')
...
**Upstream page:** [https://doi.org/10.5061/dryad.wstqjq2n5](https://doi.org/10.5061/dryad.wstqjq2n5)

**Source-term evidence:** [https://doi.org/10.5061/dryad.wstqjq2n5](https://doi.org/10.5061/dryad.wstqjq2n5)
...
```bibtex
@misc{dryad_wstqjq2n5,
  title  = { Data from: Spectral inference reveals principal cone-integration rules of the zebrafish inner retina },
  note   = { Baden Tom, Bartel Philipp, Yoshimatsu Takeshi, Janiak Filip K. Data from: Spectral inference reveals principal cone-integration rules of the zebrafish inner retina. Dryad. 2021. doi:10.5061/dryad.wstqjq2n5 },
  year   = { 2021 },
  url    = { https://doi.org/10.5061/dryad.wstqjq2n5 },
}
```
...
```text
Baden Tom, Bartel Philipp, Yoshimatsu Takeshi, Janiak Filip K. Data from: Spectral inference reveals principal cone-integration rules of the zebrafish inner retina. Dryad. 2021. doi:10.5061/dryad.wstqjq2n5
```
