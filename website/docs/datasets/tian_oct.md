...
| --- | ---: | --- | --- | --- | --- |
| Primary | 10 | `volumes` | Primary quantity reported in the reviewed catalog source | `legacy_catalog_field` | [https://doi.org/10.1371/journal.pone.0133908.s002](https://doi.org/10.1371/journal.pone.0133908.s002) |
