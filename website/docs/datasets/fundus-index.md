...
| --- | --- | ---:| ---:| --- | --- |
| [`airogs`](./airogs.md) | AIROGS: AI for Robust Glaucoma Screening | 113,893 images | 40.0 GB | `cc-by-nc-nd` | Direct HTTP |
| [`multieye`](./multieye.md) | MultiEYE: OCT-Enhanced Fundus Multi-Disease Benchmark | 103,959 images | 27.3 GB | `mit` | HuggingFace Hub |
| [`eyecare_100k`](./eyecare_100k.md) | Eyecare-100K: Multimodal Ophthalmology VQA Corpus | 102,000 question answer pairs | 30.0 GB | `unknown` | HuggingFace Hub |
| [`justraigs`](./justraigs.md) | JustRAIGS: Just Referral AI Glaucoma Screening Dataset | 101,442 images | 100.0 GB | `cc-by-nc-nd` | Zenodo |
...
| [`brset`](./brset.md) | BRSET: Brazilian Multilabel Ophthalmological Dataset | 16,266 images | 9.0 GB | `research-only` | PhysioNet |
| [`deepeyenet`](./deepeyenet.md) | DeepEyeNet (DEN): Fundus Report Generation Dataset | 15,709 images | 5.0 GB | `research-only` | Manual (upstream-gated) |
| [`aod`](./aod.md) | AOD: Augmented Ocular Diseases Dataset | 14,813 images | 2.0 GB | `unknown` | Kaggle |
| [`dme_vqa`](./dme_vqa.md) | Diabetic Macular Edema Visual Question Answering Dataset | 13,470 question answer pairs | 0.1 GB | `cc-by` | Zenodo |
| [`dme_vqa_logical`](./dme_vqa_logical.md) | DME VQA Dataset with Logical Relations | 13,470 question answer pairs | 0.1 GB | `cc-by` | Zenodo |
| [`retinal_vessel_robustness`](./retinal_vessel_robustness.md) | Natural Robustness Benchmark for Retinal Vessel Segmentation | 13,024 images | 8.2 GB | `mit` | Zenodo |
| [`ddr`](./ddr.md) | DDR: Diabetic Retinopathy Detection & Grading | 12,522 images | 4.0 GB | `mit` | Google Drive |
| [`smdg`](./smdg.md) | SMDG-19: Standardized Multi-channel Glaucoma Benchmark | 12,449 images | 5.0 GB | `cc0` | Kaggle |
| [`lag`](./lag.md) | LAG: Large-scale Attention-based Glaucoma Database | 11,760 images | 3.0 GB | `research-only` | Manual (upstream-gated) |
...
| [`jichi`](./jichi.md) | Jichi Medical University Diabetic Retinopathy Dataset | 9,939 images | 10.0 GB | `cc-by` | Figshare |
| [`retina_age_analysis`](./retina_age_analysis.md) | Retina Age Analysis | 9,857 images | 1.0 GB | `mit` | HuggingFace Hub |
...
| [`farfum_rop`](./farfum_rop.md) | FARFUM-ROP: Fundus Annotation Repository for Retinopathy of Prematurity | 1,533 images | 1.0 GB | `cc-by` | Figshare |
| [`riga_plus`](./riga_plus.md) | RIGA+ Domain Adaptation Dataset | 1,461 images | Not reported | `cc-by` | Zenodo |
| [`fundus_domain_generalization`](./fundus_domain_generalization.md) | Fundus Dataset for Domain Generalization in Optic Disc/Cup Segmentation | 1,441 images | 0.6 GB | `cc-by` | Zenodo |
...
| [`rfmid2`](./rfmid2.md) | RFMiD 2.0 Auxiliary Multi-Disease Fundus Dataset | 860 images | 0.5 GB | `cc-by` | Zenodo |
| [`fives`](./fives.md) | FIVES: Fundus Image Vessel Segmentation | 800 images | 1.1 GB | `cc-by` | Figshare |
| [`paraguay_dr`](./paraguay_dr.md) | Paraguay Color Fundus DR Dataset | 757 images | 0.5 GB | `cc-by` | Zenodo |
| [`riga`](./riga.md) | RIGA: Retinal Fundus Images for Glaucoma Analysis | 750 images | 2.0 GB | `cc-by-nc` | Direct HTTP |
...
| [`idrid`](./idrid.md) | IDRiD: Indian Diabetic Retinopathy Image Dataset | 516 images | 2.5 GB | `cc-by` | Manual (upstream-gated) |
| [`aptos_arcade_onh_masks`](./aptos_arcade_onh_masks.md) | APTOS Vascular Arcade and Optic Nerve Head Masks | 500 images | 0.1 GB | `apache` | Zenodo |
| [`coph100`](./coph100.md) | COph100: Comprehensive Infant Fundus Image Registration Dataset (RIDIRP) | 491 image pairs | 1.0 GB | `cc-by` | Figshare |
| [`papila`](./papila.md) | PAPILA: Glaucoma Fundus Dataset with Clinical Data | 488 images | 0.4 GB | `cc-by` | Direct HTTP |
| [`rimone_dl`](./rimone_dl.md) | RIM-ONE DL | 485 images | 0.5 GB | `cc-by` | Kaggle |
| [`e_ophtha`](./e_ophtha.md) | E-ophtha (EX + MA): Exudate and Microaneurysm Segmentation | 463 images | 1.0 GB | `research-only` | Kaggle |
| [`fundus_report_dataset`](./fundus_report_dataset.md) | Fundus Report Dataset | 422 image report pairs | 0.5 GB | `cc-by` | HuggingFace Hub |
| [`toxofundus`](./toxofundus.md) | ToxoFundus: Ocular Toxoplasmosis Fundus Dataset | 412 images | 0.2 GB | `cc-by` | Kaggle |
| [`ichallenge_amd`](./ichallenge_amd.md) | iChallenge-AMD: Age-related Macular Degeneration | 400 images | 1.5 GB | `research-only` | Manual (upstream-gated) |
| [`paired_retina`](./paired_retina.md) | Paired Retina Dataset: Cross-Device Fundus Pairs | 399 images | 3.0 GB | `unknown` | HuggingFace Hub |
| [`myopic_regression_fundus`](./myopic_regression_fundus.md) | Myopic Regression after Corneal Refractive Surgery Fundus Sample | 330 images | 0.2 GB | `cc-by` | Mendeley Data |
| [`gamma`](./gamma.md) | GAMMA — Glaucoma Grading from Multi-Modality Images | 300 volumes | 5.0 GB | `cc-by-nc-nd` | Google Drive |
| [`bajwa_multi_eye`](./bajwa_multi_eye.md) | Bajwa Hospital Multi Eye Disease Dataset | 300 images | 0.2 GB | `cc-by` | Mendeley Data |
| [`csc_fundus_segmentation`](./csc_fundus_segmentation.md) | Central Serous Chorioretinopathy Fundus Segmentation Dataset | 287 images | 0.5 GB | `cc-by` | Mendeley Data |
| [`maples_dr`](./maples_dr.md) | MAPLES-DR: Montreal Annotation Project for DR | 198 images | 0.5 GB | `cc-by` | Figshare |
| [`csdi`](./csdi.md) | CSDI: Cataract Severity Diagnostic Image Dataset | 187 images | 1.0 GB | `cc-by` | HuggingFace Hub |
| [`hei_med`](./hei_med.md) | HEI-MED: Hamilton Eye Institute Macular Edema Dataset | 169 images | 0.3 GB | `research-only` | GitHub |
| [`corneal_curvature_fundus`](./corneal_curvature_fundus.md) | Corneal Curvature Prediction Using Fundus Photography | 150 images | 0.1 GB | `cc-by` | Mendeley Data |
...
| [`fire`](./fire.md) | FIRE: Fundus Image Registration Dataset | 129 images | 1.0 GB | `research-only` | Direct HTTP |
...
| [`real_fundus`](./real_fundus.md) | Real Fundus Clinical Image Restoration Benchmark | 120 image pairs | 1.0 GB | `unknown` | Manual (upstream-gated) |
| [`ut_fsocta`](./ut_fsocta.md) | UTHealth Fundus and Synthetic OCTA Dataset | 112 participants | Not reported | `unknown` | Zenodo |
| [`drions_db`](./drions_db.md) | DRIONS-DB: Digital Retinal Images for Optic Nerve Segmentation | 110 images | 0.2 GB | `research-only` | Direct HTTP |
| [`drishti_gs`](./drishti_gs.md) | DRISHTI-GS: Optic Disc and Cup Segmentation | 101 images | 0.8 GB | `research-only` | Kaggle |
...
| [`mendeley_improved_retinal_displacement_quantification_between_retinal`](./mendeley_improved_retinal_displacement_quantification_between_retinal.md) | Improved Retinal Displacement Quantification Between Retinal Vessels and Corresponding Retinal Vessel Printings Across the 3D Spherical Surface of the Eye: Dataset of Measurements on Fundus Autofluorescence Imaging | 53 participants | Not reported | `cc-by` | Mendeley Data |
...
| [`hrf_seg_plus`](./hrf_seg_plus.md) | HRF-Seg+: Multi-Structure Fundus Annotations | 45 images | 0.0 GB | `cc-by` | Zenodo |
| [`ravir`](./ravir.md) | RAVIR: Retinal Artery/Vein Segmentation in IR | 42 images | 0.1 GB | `research-only` | Google Drive |
| [`fovea`](./fovea.md) | FOVEA: Pre/Intra-Operative Fundus + Biomicroscopy | 40 participants | 4.0 GB | `cc-by` | Figshare |
| [`rite`](./rite.md) | RITE: Retinal Images Vessel Tree Extraction (Artery/Vein) | 40 images | 0.1 GB | `research-only` | Manual (upstream-gated) |
| [`rbad`](./rbad.md) | RBAD Retinal Branching-Angle Detection Benchmark | 40 images | Not reported | `research-only` | GitHub |
| [`drive`](./drive.md) | DRIVE: Digital Retinal Images for Vessel Extraction | 40 images | Not reported | `unknown` | Manual (upstream-gated) |
| [`chase_db1`](./chase_db1.md) | CHASE_DB1: Child Heart and Health Study in England | 28 images | 0.1 GB | `cc-by` | Manual (upstream-gated) |
...
| [`china_fundus_cimt`](./china_fundus_cimt.md) | China Fundus and Carotid Intima-Media Thickness Dataset | Not reported | Not reported | `cc-by` | Figshare |
...
| [`mendeley_fundus_autofluorescence_premature_infants`](./mendeley_fundus_autofluorescence_premature_infants.md) | Fundus Autofluorescence in Premature Infants | Not reported | Not reported | `cc-by` | Mendeley Data |
