...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_d12d9f` |
| **Full name** | Excitatory neurotransmission activates compartmentalized calcium transients in Müller glia without affecting lateral process motility |
...
> Scope screen: adjacent_add. Current Dryad v4 file listing: 16 files, 2052296419 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_d12d9f --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_d12d9f --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_d12d9f')
...
**Upstream page:** [https://doi.org/10.6078/d12d9f](https://doi.org/10.6078/d12d9f)

**Source-term evidence:** [https://doi.org/10.6078/d12d9f](https://doi.org/10.6078/d12d9f)
...
@misc{dryad_d12d9f,
  title  = { Excitatory neurotransmission activates compartmentalized calcium transients in Müller glia without affecting lateral process motility },
  note   = { Tworig Joshua, Coate Chandler, Feller Marla. Excitatory neurotransmission activates compartmentalized calcium transients in Muller glia without affecting lateral process motility. Dryad. 2022. doi:10.6078/d12d9f },
  year   = { 2022 },
  url    = { https://doi.org/10.6078/d12d9f },
}
```
...
```text
Tworig Joshua, Coate Chandler, Feller Marla. Excitatory neurotransmission activates compartmentalized calcium transients in Muller glia without affecting lateral process motility. Dryad. 2022. doi:10.6078/d12d9f
```
