---
id: dryad_xwdbrv1kd
title: "GTPBP2 in-frame deletion in a canine model with progressive retinal degeneration"
sidebar_label: dryad_xwdbrv1kd
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_xwdbrv1kd` |
| **Full name** | GTPBP2 in-frame deletion in a canine model with progressive retinal degeneration |
...
> Scope screen: adjacent_add. Current Dryad v7 file listing: 11 files, 199231877370 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_xwdbrv1kd --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_xwdbrv1kd --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_xwdbrv1kd')
...
**Upstream page:** [https://doi.org/10.5061/dryad.xwdbrv1kd](https://doi.org/10.5061/dryad.xwdbrv1kd)

**Source-term evidence:** [https://doi.org/10.5061/dryad.xwdbrv1kd](https://doi.org/10.5061/dryad.xwdbrv1kd)
...
```bibtex
@misc{dryad_xwdbrv1kd,
  title  = { GTPBP2 in-frame deletion in a canine model with progressive retinal degeneration },
  note   = { Murgiano Leonardo, Niggel Jessica K., Akyurek Eylem Emek, Sacchetto Roberta, Aguirre Gustavo D.. GTPBP2 in-frame deletion in a canine model with progressive retinal degeneration. Dryad. 2025. doi:10.5061/dryad.xwdbrv1kd },
  year   = { 2025 },
  url    = { https://doi.org/10.5061/dryad.xwdbrv1kd },
}
```
...
```text
Murgiano Leonardo, Niggel Jessica K., Akyurek Eylem Emek, Sacchetto Roberta, Aguirre Gustavo D.. GTPBP2 in-frame deletion in a canine model with progressive retinal degeneration. Dryad. 2025. doi:10.5061/dryad.xwdbrv1kd
```
