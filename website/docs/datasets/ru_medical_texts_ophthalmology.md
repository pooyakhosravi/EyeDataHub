...
| --- | ---: | --- | --- | --- | --- |
| Primary | 3,473 | `sentence_pairs` | Russian-English sentence or glossary pairs | `official_source_description` | [kaggle.com/datasets](https://www.kaggle.com/datasets/cheshrcat/ru-medical-texts-ophtalmology) |
