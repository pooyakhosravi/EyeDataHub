---
id: dryad_d1895r
title: "Directed Evolution of AAV for Efficient Gene Delivery to Canine and Primate Retina - Raw counts of variants from deep sequencing"
sidebar_label: dryad_d1895r
...
| Field | Value |
| --- | --- |
| **Short name** | `dryad_d1895r` |
| **Full name** | Directed Evolution of AAV for Efficient Gene Delivery to Canine and Primate Retina - Raw counts of variants from deep sequencing |
...
> Scope screen: adjacent_add. Current Dryad v1 file listing: 3 files, 180282926 bytes.
...
```bash
# Read-only preflight
eyehub download dryad_d1895r --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_d1895r --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_d1895r')
...
**Upstream page:** [https://doi.org/10.6078/d1895r](https://doi.org/10.6078/d1895r)

**Source-term evidence:** [https://doi.org/10.6078/d1895r](https://doi.org/10.6078/d1895r)
...
@misc{dryad_d1895r,
  title  = { Directed Evolution of AAV for Efficient Gene Delivery to Canine and Primate Retina - Raw counts of variants from deep sequencing },
  note   = { Byrne Leah, Day Timothy, Visel Meike, Dalkara Deniz, Dufour Valerie, Pompeo Marinho Felipe, Merigan William, Aguirre Gustavo, Beltran William, Schaffer David, Flannery John. Directed Evolution of AAV for Efficient Gene Delivery to Canine and Primate Retina - Raw counts of variants from deep sequencing. Dryad. 2018. doi:10.6078/d1895r },
  year   = { 2018 },
  url    = { https://doi.org/10.6078/d1895r },
}
```
