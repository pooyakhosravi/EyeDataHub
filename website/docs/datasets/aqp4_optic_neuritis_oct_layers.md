---
id: aqp4_optic_neuritis_oct_layers
...
# AQP4 Optic Neuritis OCT Layers Dataset
...
```bash
# Read-only preflight
eyehub download aqp4_optic_neuritis_oct_layers --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download aqp4_optic_neuritis_oct_layers --data-dir ./data
```
...
ds = REGISTRY.get_dataset('aqp4_optic_neuritis_oct_layers')
...
**Upstream page:** [https://doi.org/10.6084/m9.figshare.3209908.v1](https://doi.org/10.6084/m9.figshare.3209908.v1)

**Source-term evidence:** [https://doi.org/10.6084/m9.figshare.3209908.v1](https://doi.org/10.6084/m9.figshare.3209908.v1)
...
```bibtex
@misc{aqp4_optic_neuritis_oct_layers,
  title  = { AQP4 Optic Neuritis OCT Layers Dataset },
  note   = { Repository dataset record. 10.6084/m9.figshare.3209908.v1 },
  url    = { https://doi.org/10.6084/m9.figshare.3209908.v1 },
}
```
...
```text
Repository dataset record. 10.6084/m9.figshare.3209908.v1.
```
