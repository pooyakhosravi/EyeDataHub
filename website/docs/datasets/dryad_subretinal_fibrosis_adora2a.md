---
id: dryad_subretinal_fibrosis_adora2a
...
sidebar_label: dryad_subretinal_fibrosis_adora2a
description: "Forty-five raw omics files with treatment metadata define a translational mouse subretinal-fibrosis mechanism resource."
...
Forty-five raw omics files with treatment metadata define a translational mouse subretinal-fibrosis mechanism resource.

## At a glance

| Field | Value |
| --- | --- |
| **Short name** | `dryad_subretinal_fibrosis_adora2a` |
| **Full name** | Inactivation of adenosine receptor 2A suppresses endothelial-to-mesenchymal transition and inhibits subretinal fibrosis in mice |
...
> Scope: adjacent_add. Named file-level object: Raw proteomics/metabolomics files plus sample-treatment metadata. Official Dryad API metadata and current file listing reviewed 2026-08-01.
...
```bash
# Read-only preflight
eyehub download dryad_subretinal_fibrosis_adora2a --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download dryad_subretinal_fibrosis_adora2a --data-dir ./data
```
...
ds = REGISTRY.get_dataset('dryad_subretinal_fibrosis_adora2a')
...
**Upstream page:** [https://doi.org/10.5061/dryad.hx3ffbgmv](https://doi.org/10.5061/dryad.hx3ffbgmv)

**Source-term evidence:** [https://doi.org/10.5061/dryad.hx3ffbgmv](https://doi.org/10.5061/dryad.hx3ffbgmv)
...
```bibtex
@misc{dryad_subretinal_fibrosis_adora2a,
  title  = { Inactivation of adenosine receptor 2A suppresses endothelial-to-mesenchymal transition and inhibits subretinal fibrosis in mice },
  note   = { Inactivation of adenosine receptor 2A suppresses endothelial-to-mesenchymal transition and inhibits subretinal fibrosis in mice. Dryad Dataset. doi:10.5061/dryad.hx3ffbgmv },
  url    = { https://doi.org/10.5061/dryad.hx3ffbgmv },
}
```
...
```text
Inactivation of adenosine receptor 2A suppresses endothelial-to-mesenchymal transition and inhibits subretinal fibrosis in mice. Dryad Dataset. doi:10.5061/dryad.hx3ffbgmv.
```
