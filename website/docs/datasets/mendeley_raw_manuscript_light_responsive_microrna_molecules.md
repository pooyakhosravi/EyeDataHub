---
id: mendeley_raw_manuscript_light_responsive_microrna_molecules
...
# RAW DATA to manuscript: Light-Responsive MicroRNA Molecules in Human Retinal Organoids are Differentially Regulated by Distinct Wavelengths of Light

Observation-level source data, annotations, or signals. from Human retinal organoids are explicitly stated.
...
> Human provenance: Human retinal organoids are explicitly stated. Source-review finding: One XLSX raw-data workbook.
...
```bash
# Read-only preflight
eyehub download mendeley_raw_manuscript_light_responsive_microrna_molecules --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download mendeley_raw_manuscript_light_responsive_microrna_molecules --data-dir ./data
```
...
ds = REGISTRY.get_dataset('mendeley_raw_manuscript_light_responsive_microrna_molecules')
...
**Upstream page:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/8ksg9fssd9/1)

**Source-term evidence:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/8ksg9fssd9)
...
```bibtex
@misc{mendeley_raw_manuscript_light_responsive_microrna_molecules,
  title  = { RAW DATA to manuscript: Light-Responsive MicroRNA Molecules in Human Retinal Organoids are Differentially Regulated by Distinct Wavelengths of Light },
  note   = { RAW DATA to manuscript: Light-Responsive MicroRNA Molecules in Human Retinal Organoids are Differentially Regulated by Distinct Wavelengths of Light. Mendeley Data, V1. doi:10.17632/8ksg9fssd9.1 },
  url    = { https://data.mendeley.com/datasets/8ksg9fssd9/1 },
}
```
...
```text
RAW DATA to manuscript: Light-Responsive MicroRNA Molecules in Human Retinal Organoids are Differentially Regulated by Distinct Wavelengths of Light. Mendeley Data, V1. doi:10.17632/8ksg9fssd9.1.
```
