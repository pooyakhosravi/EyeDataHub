---
id: mendeley_serum_proteomic_profiles_keratoconus_post_laser
...
> Human provenance: Keratoconus, post-laser ectasia, PMD and control participants. Source-review finding: Sample metadata plus unprocessed MALDI-TOF/TOF peak-intensity table.
...
```bash
# Read-only preflight
eyehub download mendeley_serum_proteomic_profiles_keratoconus_post_laser --data-dir ./data --dry-run --json

# Download, only when preflight reports supported behavior
eyehub download mendeley_serum_proteomic_profiles_keratoconus_post_laser --data-dir ./data
```
...
ds = REGISTRY.get_dataset('mendeley_serum_proteomic_profiles_keratoconus_post_laser')
...
**Upstream page:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/yzsktrxh6y/1)

**Source-term evidence:** [data.mendeley.com/datasets](https://data.mendeley.com/datasets/yzsktrxh6y)
...
```bibtex
@misc{mendeley_serum_proteomic_profiles_keratoconus_post_laser,
  title  = { Serum proteomic profiles in keratoconus, post-laser vision correction ectasia, and pellucid marginal degeneration },
  note   = { Serum proteomic profiles in keratoconus, post-laser vision correction ectasia, and pellucid marginal degeneration. Mendeley Data, V1. doi:10.17632/yzsktrxh6y.1 },
  url    = { https://data.mendeley.com/datasets/yzsktrxh6y/1 },
}
```
...
```text
Serum proteomic profiles in keratoconus, post-laser vision correction ectasia, and pellucid marginal degeneration. Mendeley Data, V1. doi:10.17632/yzsktrxh6y.1.
```
